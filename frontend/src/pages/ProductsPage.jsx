...
export default function ProductsPage() {
  ...
  if (loading) return <p style={{ color: '#666', padding: '2rem 0' }}>Loading products…</p>;
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
        ...
        <span style={{ fontSize: '0.75rem', color: '#555', letterSpacing: '0.05em', textTransform: 'uppercase' }}>{products.length} items</span>
      </div>

      {products.length === 0 ? (
        <p style={{ color: '#555' }}>No products available yet.</p>
      ) : (
